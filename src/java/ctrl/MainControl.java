...
// grazinti sarasa 
    ...
    public String getCategory() {    //http://localhost:9999/WS_full/category/getCat
  ...
  // get pasirinkta reiksme pagal pavadinima
    ...
    @ResponseStatus(value= HttpStatus.OK)
    @ResponseBody //Kad grąžintų atsakymą iš db į browserį
    public String getThat(@PathVariable String reiksme) {    //http://localhost:9999/WS_full/category/getThat_MAISTAS
        AsmeniniuFinansuValdymoSistema a = new AsmeniniuFinansuValdymoSistema();
